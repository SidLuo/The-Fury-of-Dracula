...
char *idToAbbrev(LocationID location);

#define isLand(place)  (idToType(place) == LAND)
#define isSea(place)  (idToType(place) == SEA)

#define validPlace(pid) (pid >= MIN_MAP_LOCATION && pid <= MAX_MAP_LOCATION+NUM_OTHER_LOCATIONS)
